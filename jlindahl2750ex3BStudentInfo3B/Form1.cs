    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
           ...
           this.school.Terms = this.dbContext.Terms.ToList();
            ...
            comc2750.Sections = 
                this.dbContext.Sections.Where(s => s.Course.Id == comc2750.Id && s.Term.Id == spr2020.Id).ToList();
            ...
            section2750.Assignments = this.dbContext.Assignments.ToList();
            this.assignmentsListBox.DisplayMember = "DisplayString";
            this.assignmentsListBox.DataSource = section2750.Assignments;
            Assignment assignment2750 = section2750.FindAssignment("1A, Max Points: 10, 1/23/2019");

            section2750.Enrollments = this.dbContext.Enrollments.Include("Student").Where(enr => enr.Section.Id == section2750.Id).ToList();
            ...
            AssignmentGrade grade = this.dbContext.AssignmentGrades.Where(g => g.Enrollment.Id == selectedEnrollment.Id && g.Assignment.Id == selectedAssignment.Id).SingleOrDefault();
            this.pointsTextBox.Text = grade.Points.ToString();
            this.dateTextBox.Text = grade.DateCompleted.ToString();
        ...
        private void coursesDropDownList_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                selectedCourse.Sections = this.dbContext.Sections.Where(s => s.Course.Id == selectedCourse.Id && s.Term.Id == selectedTerm.Id).ToList();
        ...
        private void sectionsDropDownList_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                selectedSection.Enrollments = this.dbContext.Enrollments.Include("Student").Where(enr => enr.Section.Id == selectedSection.Id).ToList();

                selectedSection.Assignments = this.dbContext.Assignments.ToList();
